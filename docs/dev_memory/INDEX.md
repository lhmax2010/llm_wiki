...
## 当前状态
- 当前活跃 Phase：phase_2_governed_api_pipeline（开 Phase / 风险档待确认）
...
| phase_2 | governed-api-pipeline | 进行中 | `docs/dev_memory/phase_2_governed_api_pipeline/` | 待创建 | baseline 924ec2d |
