...
> Each phase keeps `plan.md`, `progress.md`, and `result.md` under its own folder.
...
| Phase | Slug | Status | dev_memory | PR | Git Commit |
|------|------|--------|------------|----|------------|
...
| Date | Slug | Status | dev_memory | PR | Git Commit |
|------|------|--------|------------|----|------------|
...
| 2026-08-17 | credibility-preserve-web-edit | Merged | `docs/dev_memory/credibility_preserve_web_edit/` | https://github.com/lhmax2010/llm_wiki/pull/17 | 6aa6d90 (merge), b9f6cea (PR head/docs), c0cd6ea (FIX-2 backend), aef2677 (FIX-1 frontend) |
